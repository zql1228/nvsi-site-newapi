<template>
  <div class="zyz-page flex-v">
    <div class="zyz-header bgckgroud2">
      <div class="zyz-header-djs">
        <p class="flex-h v-m">
          距报名结束仅剩: <span v-text="parseInt(days) > 0 ? days : '00'"></span
          ><i style="color: #fff">天</i
          ><span v-text="parseInt(hours) > 0 ? hours : '00'"></span
          ><i style="color: #fff">时</i
          ><span v-text="parseInt(minutes) > 0 ? minutes : '00'"></span
