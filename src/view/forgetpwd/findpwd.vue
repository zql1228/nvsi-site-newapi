        ...
        <ul class="row w">
          <li class="col">
            <div class="router">
              ...
              <router-link tag="a" :to="{ name: 'findpwd' }">账户申诉</router-link>
            </div>
          </li>
        </ul>
        <!-- 主体 -->
        <div class="J-main J-auto">
          <div class="J-find-page" style="width: 1100px">
            ...
            <p class="J-find-page_h1_p">
              注：仅支持志愿者进行账号申诉，若您已申诉，请点击<a href="javascript:void(0);" style="color: red" @click="$router.push('/appeal')">【申诉进度】</a>查询
            </p>
            <!-- 姓名输入框 -->
            <div class="J-mt-23">
              <p class="J-find-page_p">
                <span class="J-find-page_span">* </span>真实姓名
                <span style="font-size: 14px">（若姓名中涉及标点符号，请使用中文字符圆点，同右侧样式“·”)</span>
              </p>
              <div class="J-find-page__inputgap">
                <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-personal.png" alt="" />
            ...
            <div class="J-mt-23">
              ...
              <div class="J-find-page__inputgap">
                <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-check1.png" alt="" />
            ...
            <div class="J-mt-23">
              ...
              <div class="J-find-page__inputgap">
                <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-lock.png" alt="" />
                <input type="password" class="J-check_input" placeholder="请输入新密码" id="pwd" v-model="pwd" @blur="getpassword" maxlength="20" />
            ...
            <div class="J-mt-23">
              ...
              <div class="J-find-page__inputgap">
                <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-lock.png" alt="" />
                <input type="password" class="J-check_input" placeholder="请输入确认密码" id="repwd" v-model="repwd" @blur="getrepassword" maxlength="20" />
                <img src="../../assets/img/hide.png" alt="" class="pwd_img" v-show="imgShow1 == 0" @click="changeType($event, 'imgShow1', 1)" />
                <img src="../../assets/img/show.png" alt="" class="pwd_img" v-show="imgShow1 == 1" @click="changeType($event, 'imgShow1', 0)" />
            ...
            <div class="J-mt-23">
              ...
              <ul class="J-check__ul">
                <li class="J-check__li" style="width: 68.5%; vertical-align: bottom">
                  <div class="J-check-img">
                    <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-check2.png" alt="" />
                    <input type="text" class="J-check_input" placeholder="请输入图文验证码" v-model="imgCode" style="font-size: 16px" @blur="getforget_img" maxlength="4" />
                  </div>
                </li>
                <li class="J-check__li" style="width: 31.5%; vertical-align: bottom">
            ...
            <div class="J-mt-23">
              ...
              <ul class="J-check__ul">
                <li class="J-check__li" style="width: 68.5%; vertical-align: bottom">
                  <div class="J-check-img">
                    <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-check2.png" alt="" />
                    <input type="text" class="J-check_input" placeholder="请选择区域" v-model="orgAreaName" style="font-size: 16px" @blur="orgAreaCheck" readonly />
                  </div>
                </li>
                <li class="J-check__li" style="width: 31.5%; vertical-align: bottom">
                  <a class="J-code fin_pwd_button" @click="chooseOrgArea" id="chooseOrgArea">选择</a>
                </li>
              </ul>
            ...
            <div class="J-mt-23">
              ...
              <div class="J-find-page__inputgap">
                <img class="J-check-img_img" src="../../assets/img/forgetpwd/J-phone.png" alt="" />
                <input type="text" class="J-check_input" placeholder="请输入手机号码" id="phone" v-model="phone" @blur="getPhone" maxlength="11" />
                <span class="J-smb span-i" id="phoneTip"></span>
              </div>
            </div>
            <!-- 证件上传 -->
            <p class="J-find-page_p J-mt-23" style="width: 100%">
              <span class="J-find-page_span">* </span>上传证件照片（证件人像面、证件国徽面照片）,大小不超过150k
            </p>
            <ul class="J-find-page__ul" style="display: flex;
          ...
          <div class="mask-info">
            <div class="mask-header row w">
              ...
              <div class="col v-m t-r">
                <a href="javascript:void(0);" @click="closeMask"><img src="../../assets/img/close.png" alt="" /></a>
              </div>
            </div>
