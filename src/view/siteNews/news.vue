...
const newsList = () => import("@/view/siteNews/components/newsList.vue"); //左侧列表-无子栏目（分页）
const newsTab = () => import("@/view/siteNews/components/newsTab.vue"); //左侧列表-有子栏目
const tabList = () => import("@/view/siteNews/components/newstabList.vue"); //左侧列表-有子栏目(分页)
