<template>
  <div>
    <div class="avatar-upload avatar-upload-small">
      <div class="avatar-upload-wrap idcardPhoto" :id="'photo' + photo" @click="uploader" style="margin: 0; width: 100%">
        <img :src="imgSrc" alt="" class="w" style="width: 316px; height: 206px; cursor: pointer" />
      </div>
      ...
      <div class="lightbox cropperBox" :id="'cropperBox' + photo">
        ...
        <div>
          <div style="
              ...
              color: #999;
            ">
            <input type="radio" :name="photo" v-model="picked" value="1" @click="changeShape(1)" /><span>横屏</span>
            <input type="radio" :name="photo" v-model="picked" value="2" @click="changeShape(2)" /><span>竖屏</span>
          </div>
      ...
      <input :id="'file' + photo" type="file" @change="changeImg" accept="image/*" hidden style="visibility: hidden" />
    </div>
  </div>
</template>
